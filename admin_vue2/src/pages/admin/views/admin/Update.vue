        ...
        <b-container fluid>
            ...
            <b-card title="업데이트">
                ...
                <div class="d-flex justify-content-end mt-3">
                    <b-button to="/admin/updateform" size="sm" variant="primary">업데이트 등록하기</b-button>
                </div>
            </b-card>
        </b-container>
    </div>
...
export default {
    ...
    methods: {
        ...
        editItem(item) {
            console.log(item)
            router.push(`/admin/update/${item[4]}`)
        },
        // 목록 불러오기
        getDataLoad() {
            updateApi.getUpdateList().then((res) => {
